...
model_young = joblib.load("../artifacts/best_model.joblib")
model_rest = joblib.load("../artifacts/model_rest.joblib")
scaler_young = joblib.load("../artifacts/scaler_rest.joblib")
scaler_rest = joblib.load("../artifacts/scaler_young.joblib")
...
def preprocess_input(input_dict):
    ...
    expected_columns = [
        ...
        'smoking_status_Not Smoking', 'smoking_status_Occasional', 'smoking_status_Regular',
    ...
    for key, value in input_dict.items():
        if key == 'Gender' and value == 'Male':
            ...
            if value == 'No Smoking':  # Match the UI value
                df['smoking_status_Not Smoking'] = 1
